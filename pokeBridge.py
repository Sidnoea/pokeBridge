...
class Box:
    ...
    OLD_LENGTH = 1102 #length of old Box in bytes
    ...
    def __init__(self, data):
        ...
        count = data[0x0]
        self.species = [i for i in data[0x1:0x1 + count]] #todo: eggs are here?
        self.pokemon = []
...
class SaveGame:
    '''A set of 14 Sectors representing a save game. Takes a bytes
    object as its old data.'''
...
class OldSaveFile:
    ...
    def unloadBox(self, boxNum):
        ...
        boxStarts = [0x4000, 0x4450, 0x48a0, 0x4cf0, 0x5140, 0x5590, 0x59e0, 0x6000, 0x6450, 0x68a0, 0x6cf0, 0x7140, 0x7590, 0x79e0]
        start = boxStarts[boxNum-1]
    ...
    def save(self, filename):
        ...
        #todo: do both copies of the save game need to be changed?
...
def transfer(oldGen2, newGen2, oldGen3, newGen3, oldBoxNums, newBoxNums,
    ...
    '''Takes 4 string file names, 2 lists of integers, and 3 strings,
    writes 2 new save files with the indicated boxes transferred.'''
